...
def colorline(axs, x, y, z=None, colormap = 'jet', cmap=None, segmented_cmap=False, norm = None, linewidth=3, alpha=1.0):
    '''
...
def colorline2(ax, x,y,z,linewidth=1, colormap='jet', norm=None, zorder=1, alpha=1, linestyle='solid', cmap=None, hide_nan_indices=False, hack_round_caps=False):
        '''
        From Floris Van Breugel: https://github.com/florisvb/FlyPlotLib/blob/master/fly_plot_lib/plot.py
...
def paired_plot(axs,obs1,obs2,color1='r',color2='b',line_color='k', log=False,
    ...
    mean_std=True, markersize=5, indiv_pts=False, error=True, indiv_markers=True, error_ast=True):
    """
